...
def auto_params(question : str, radius : int, N : int = 1100, k : int = 3, alpha : float = 0.5, alpha_1 : float = 0.05, alpha_2 : float = 0.1, delta : int = 5):
    """
    ...
    if (rho > 0.98):
        quantile = -1
    quantile = int(1250*math.ln(1/0.1))+200
